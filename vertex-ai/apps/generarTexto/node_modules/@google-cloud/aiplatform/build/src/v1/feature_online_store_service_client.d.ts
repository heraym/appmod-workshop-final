 ...
 * @memberof v1
 */
export declare class FeatureOnlineStoreServiceClient {
    private _terminated;
    private _opts;
    ...
    featureOnlineStoreServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     ...
     * @param {google.cloud.aiplatform.v1.FeatureViewDataKey} [request.dataKey]
     *   Optional. The request key to fetch feature values for.
     * @param {google.cloud.aiplatform.v1.FeatureViewDataFormat} [request.dataFormat]
     *   Optional. Response data format. If not set,
     *   {@link protos.google.cloud.aiplatform.v1.FeatureViewDataFormat.KEY_VALUE|FeatureViewDataFormat.KEY_VALUE}
     *   will be used.
     * @param {object} [options]
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1.FetchFeatureValuesResponse|FetchFeatureValuesResponse}.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1/feature_online_store_service.fetch_feature_values.js</caption>
     * region_tag:aiplatform_v1_generated_FeatureOnlineStoreService_FetchFeatureValues_async
     */
    fetchFeatureValues(request?: protos.google.cloud.aiplatform.v1.IFetchFeatureValuesRequest, options?: CallOptions): Promise<[
        protos.google.cloud.aiplatform.v1.IFetchFeatureValuesResponse,
        protos.google.cloud.aiplatform.v1.IFetchFeatureValuesRequest | undefined,
        {} | undefined
    ]>;
    fetchFeatureValues(request: protos.google.cloud.aiplatform.v1.IFetchFeatureValuesRequest, options: CallOptions, callback: Callback<protos.google.cloud.aiplatform.v1.IFetchFeatureValuesResponse, protos.google.cloud.aiplatform.v1.IFetchFeatureValuesRequest | null | undefined, {} | null | undefined>): void;
    fetchFeatureValues(request: protos.google.cloud.aiplatform.v1.IFetchFeatureValuesRequest, callback: Callback<protos.google.cloud.aiplatform.v1.IFetchFeatureValuesResponse, protos.google.cloud.aiplatform.v1.IFetchFeatureValuesRequest | null | undefined, {} | null | undefined>): void;
    /**
