 ...
 * `src/v1beta1/index_service_client_config.json`.
...
class IndexServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createIndexResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.Index');
        const createIndexMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CreateIndexOperationMetadata');
        const updateIndexResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.Index');
        const updateIndexMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdateIndexOperationMetadata');
        const deleteIndexResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteIndexMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.IndexService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.indexServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.IndexService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1beta1.IndexService, this._opts, this._providedCustomServicePath);
     ...
     *   {@link protos.google.cloud.aiplatform.v1beta1.ListIndexesResponse.next_page_token|ListIndexesResponse.next_page_token}
     *   of the previous
     *   {@link protos.google.cloud.aiplatform.v1beta1.IndexService.ListIndexes|IndexService.ListIndexes}
     *   call.
     ...
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.aiplatform.v1beta1.Index|Index} on 'data' event.
     ...
     *   {@link protos.google.cloud.aiplatform.v1beta1.Index|Index}. The API will be called under the hood as needed, once per the page,
