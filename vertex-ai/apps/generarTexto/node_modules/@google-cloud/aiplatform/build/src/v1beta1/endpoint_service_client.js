...
class EndpointServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createEndpointResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.Endpoint');
        const createEndpointMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CreateEndpointOperationMetadata');
        const deleteEndpointResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteEndpointMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const deployModelResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeployModelResponse');
        const deployModelMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeployModelOperationMetadata');
        const undeployModelResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UndeployModelResponse');
        const undeployModelMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UndeployModelOperationMetadata');
        const mutateDeployedModelResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.MutateDeployedModelResponse');
        const mutateDeployedModelMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.MutateDeployedModelOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.EndpointService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.endpointServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.EndpointService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1beta1.EndpointService, this._opts, this._providedCustomServicePath);
