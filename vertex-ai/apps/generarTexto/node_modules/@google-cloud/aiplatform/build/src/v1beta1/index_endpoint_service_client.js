...
class IndexEndpointServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createIndexEndpointResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.IndexEndpoint');
        const createIndexEndpointMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CreateIndexEndpointOperationMetadata');
        const deleteIndexEndpointResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteIndexEndpointMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const deployIndexResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeployIndexResponse');
        const deployIndexMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeployIndexOperationMetadata');
        const undeployIndexResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UndeployIndexResponse');
        const undeployIndexMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UndeployIndexOperationMetadata');
        const mutateDeployedIndexResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.MutateDeployedIndexResponse');
        const mutateDeployedIndexMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.MutateDeployedIndexOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.IndexEndpointService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.indexEndpointServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.IndexEndpointService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1beta1
                    .IndexEndpointService, this._opts, this._providedCustomServicePath);
