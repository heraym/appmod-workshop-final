...
class FeaturestoreServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createFeaturestoreResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.Featurestore');
        const createFeaturestoreMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CreateFeaturestoreOperationMetadata');
        const updateFeaturestoreResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.Featurestore');
        const updateFeaturestoreMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdateFeaturestoreOperationMetadata');
        const deleteFeaturestoreResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteFeaturestoreMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const createEntityTypeResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.EntityType');
        const createEntityTypeMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CreateEntityTypeOperationMetadata');
        const deleteEntityTypeResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteEntityTypeMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        ...
        const batchCreateFeaturesResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.BatchCreateFeaturesResponse');
        const batchCreateFeaturesMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.BatchCreateFeaturesOperationMetadata');
        ...
        const importFeatureValuesResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ImportFeatureValuesResponse');
        const importFeatureValuesMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ImportFeatureValuesOperationMetadata');
        const batchReadFeatureValuesResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.BatchReadFeatureValuesResponse');
        const batchReadFeatureValuesMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.BatchReadFeatureValuesOperationMetadata');
        const exportFeatureValuesResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ExportFeatureValuesResponse');
        const exportFeatureValuesMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ExportFeatureValuesOperationMetadata');
        const deleteFeatureValuesResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteFeatureValuesResponse');
        const deleteFeatureValuesMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteFeatureValuesOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.FeaturestoreService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.featurestoreServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.FeaturestoreService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1beta1
                    .FeaturestoreService, this._opts, this._providedCustomServicePath);
