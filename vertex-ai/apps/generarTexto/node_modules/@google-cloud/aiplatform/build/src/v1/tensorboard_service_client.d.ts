 ...
 * @memberof v1
 */
export declare class TensorboardServiceClient {
    private _terminated;
    private _opts;
     ...
     */
    readTensorboardUsage(request?: protos.google.cloud.aiplatform.v1.IReadTensorboardUsageRequest, options?: CallOptions): Promise<[
        protos.google.cloud.aiplatform.v1.IReadTensorboardUsageResponse,
        (protos.google.cloud.aiplatform.v1.IReadTensorboardUsageRequest | undefined),
        {} | undefined
    ]>;
    readTensorboardUsage(request: protos.google.cloud.aiplatform.v1.IReadTensorboardUsageRequest, options: CallOptions, callback: Callback<protos.google.cloud.aiplatform.v1.IReadTensorboardUsageResponse, protos.google.cloud.aiplatform.v1.IReadTensorboardUsageRequest | null | undefined, {} | null | undefined>): void;
    readTensorboardUsage(request: protos.google.cloud.aiplatform.v1.IReadTensorboardUsageRequest, callback: Callback<protos.google.cloud.aiplatform.v1.IReadTensorboardUsageResponse, protos.google.cloud.aiplatform.v1.IReadTensorboardUsageRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    readTensorboardSize(request?: protos.google.cloud.aiplatform.v1.IReadTensorboardSizeRequest, options?: CallOptions): Promise<[
    ...
    readTensorboardSize(request: protos.google.cloud.aiplatform.v1.IReadTensorboardSizeRequest, options: CallOptions, callback: Callback<protos.google.cloud.aiplatform.v1.IReadTensorboardSizeResponse, protos.google.cloud.aiplatform.v1.IReadTensorboardSizeRequest | null | undefined, {} | null | undefined>): void;
    readTensorboardSize(request: protos.google.cloud.aiplatform.v1.IReadTensorboardSizeRequest, callback: Callback<protos.google.cloud.aiplatform.v1.IReadTensorboardSizeResponse, protos.google.cloud.aiplatform.v1.IReadTensorboardSizeRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is Array of {@link protos.google.cloud.aiplatform.v1.TensorboardRun|TensorboardRun}.
     *   The client library will perform auto-pagination by default: it will call the API as many
     *   times as needed and will merge results from all the pages into this array.
     *   Note that it can affect your quota.
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is Array of {@link protos.google.cloud.aiplatform.v1.TensorboardTimeSeries|TensorboardTimeSeries}.
     *   The client library will perform auto-pagination by default: it will call the API as many
     *   times as needed and will merge results from all the pages into this array.
     *   Note that it can affect your quota.
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is Array of {@link protos.google.cloud.aiplatform.v1.TimeSeriesDataPoint|TimeSeriesDataPoint}.
     *   The client library will perform auto-pagination by default: it will call the API as many
     *   times as needed and will merge results from all the pages into this array.
     *   Note that it can affect your quota.
