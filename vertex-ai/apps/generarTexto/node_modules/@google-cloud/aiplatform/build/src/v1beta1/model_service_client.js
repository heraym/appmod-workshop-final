...
class ModelServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const uploadModelResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UploadModelResponse');
        const uploadModelMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UploadModelOperationMetadata');
        const updateExplanationDatasetResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdateExplanationDatasetResponse');
        const updateExplanationDatasetMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdateExplanationDatasetOperationMetadata');
        const deleteModelResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteModelMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const deleteModelVersionResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteModelVersionMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const exportModelResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ExportModelResponse');
        const exportModelMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ExportModelOperationMetadata');
        const copyModelResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CopyModelResponse');
        const copyModelMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CopyModelOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.ModelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.modelServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.ModelService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1beta1.ModelService, this._opts, this._providedCustomServicePath);
