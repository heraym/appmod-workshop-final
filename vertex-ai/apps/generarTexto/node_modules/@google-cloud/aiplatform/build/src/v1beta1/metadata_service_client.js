...
class MetadataServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const deleteArtifactMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const purgeArtifactsResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.PurgeArtifactsResponse');
        const purgeArtifactsMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.PurgeArtifactsMetadata');
        ...
        const purgeContextsResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.PurgeContextsResponse');
        const purgeContextsMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.PurgeContextsMetadata');
        const deleteExecutionResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteExecutionMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const purgeExecutionsResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.PurgeExecutionsResponse');
        const purgeExecutionsMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.PurgeExecutionsMetadata');
