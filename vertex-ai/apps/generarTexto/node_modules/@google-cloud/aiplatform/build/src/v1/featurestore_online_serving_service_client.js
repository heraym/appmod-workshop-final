...
exports.FeaturestoreOnlineServingServiceClient = void 0;
const stream_1 = require("stream");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v1/featurestore_online_serving_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./featurestore_online_serving_service_client_config.json");
...
class FeaturestoreOnlineServingServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.stream = {
            streamingReadFeatureValues: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.SERVER_STREAMING, !!opts.fallback),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.FeaturestoreOnlineServingService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.featurestoreOnlineServingServiceStub) {
            return this.featurestoreOnlineServingServiceStub;
        }
        // Put together the "service stub" for
        // google.cloud.aiplatform.v1.FeaturestoreOnlineServingService.
        this.featurestoreOnlineServingServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.FeaturestoreOnlineServingService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1
                    .FeaturestoreOnlineServingService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of featurestoreOnlineServingServiceStubMethods) {
            const callPromise = this.featurestoreOnlineServingServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    readFeatureValues(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    writeFeatureValues(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    streamingReadFeatureValues(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
...
//# sourceMappingURL=featurestore_online_serving_service_client.js.map