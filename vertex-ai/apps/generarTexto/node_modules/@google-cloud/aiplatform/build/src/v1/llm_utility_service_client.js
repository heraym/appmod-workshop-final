...
exports.LlmUtilityServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v1/llm_utility_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./llm_utility_service_client_config.json");
...
class LlmUtilityServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.LlmUtilityService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.llmUtilityServiceStub) {
            return this.llmUtilityServiceStub;
        }
        // Put together the "service stub" for
        // google.cloud.aiplatform.v1.LlmUtilityService.
        this.llmUtilityServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.LlmUtilityService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1.LlmUtilityService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const llmUtilityServiceStubMethods = ['countTokens', 'computeTokens'];
        for (const methodName of llmUtilityServiceStubMethods) {
            const callPromise = this.llmUtilityServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    computeTokens(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
...
//# sourceMappingURL=llm_utility_service_client.js.map