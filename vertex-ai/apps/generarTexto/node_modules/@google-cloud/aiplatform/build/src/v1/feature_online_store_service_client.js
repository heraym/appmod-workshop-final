...
exports.FeatureOnlineStoreServiceClient = void 0;
 ...
 */
const gapicConfig = require("./feature_online_store_service_client_config.json");
...
class FeatureOnlineStoreServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.FeatureOnlineStoreService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.featureOnlineStoreServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.FeatureOnlineStoreService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1
                    .FeatureOnlineStoreService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of featureOnlineStoreServiceStubMethods) {
            const callPromise = this.featureOnlineStoreServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    fetchFeatureValues(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
...
//# sourceMappingURL=feature_online_store_service_client.js.map