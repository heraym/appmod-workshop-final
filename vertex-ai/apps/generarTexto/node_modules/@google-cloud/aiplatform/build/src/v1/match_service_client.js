...
exports.MatchServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v1/match_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./match_service_client_config.json");
...
class MatchServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.MatchService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.matchServiceStub) {
            return this.matchServiceStub;
        }
        // Put together the "service stub" for
        // google.cloud.aiplatform.v1.MatchService.
        this.matchServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.MatchService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1.MatchService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const matchServiceStubMethods = ['findNeighbors', 'readIndexDatapoints'];
        for (const methodName of matchServiceStubMethods) {
            const callPromise = this.matchServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    findNeighbors(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    readIndexDatapoints(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
...
//# sourceMappingURL=match_service_client.js.map