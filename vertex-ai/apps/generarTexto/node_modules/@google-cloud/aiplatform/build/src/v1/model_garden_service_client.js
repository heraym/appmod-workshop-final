...
exports.ModelGardenServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v1/model_garden_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./model_garden_service_client_config.json");
...
class ModelGardenServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.ModelGardenService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.modelGardenServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.ModelGardenService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1.ModelGardenService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of modelGardenServiceStubMethods) {
            const callPromise = this.modelGardenServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getPublisherModel(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
...
//# sourceMappingURL=model_garden_service_client.js.map