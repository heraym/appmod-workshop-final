...
class JobServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const deleteCustomJobMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const deleteDataLabelingJobResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteDataLabelingJobMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const deleteHyperparameterTuningJobResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteHyperparameterTuningJobMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const deleteNasJobResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteNasJobMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const deleteBatchPredictionJobResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteBatchPredictionJobMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const updateModelDeploymentMonitoringJobResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringJob');
        const updateModelDeploymentMonitoringJobMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdateModelDeploymentMonitoringJobOperationMetadata');
        const deleteModelDeploymentMonitoringJobResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteModelDeploymentMonitoringJobMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.JobService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.jobServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.JobService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1beta1.JobService, this._opts, this._providedCustomServicePath);
