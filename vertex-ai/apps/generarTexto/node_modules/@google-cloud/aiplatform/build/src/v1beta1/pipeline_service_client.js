...
class PipelineServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const deleteTrainingPipelineMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const deletePipelineJobResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deletePipelineJobMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const batchDeletePipelineJobsResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.BatchDeletePipelineJobsResponse');
        const batchDeletePipelineJobsMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.PipelineService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.pipelineServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.PipelineService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1beta1.PipelineService, this._opts, this._providedCustomServicePath);
