...
class SpecialistPoolServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createSpecialistPoolResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.SpecialistPool');
        const createSpecialistPoolMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CreateSpecialistPoolOperationMetadata');
        const deleteSpecialistPoolResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteSpecialistPoolMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const updateSpecialistPoolResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.SpecialistPool');
        const updateSpecialistPoolMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdateSpecialistPoolOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.SpecialistPoolService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.specialistPoolServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.SpecialistPoolService')
