 ...
 * `src/v1beta1/migration_service_client_config.json`.
...
class MigrationServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const batchMigrateResourcesResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.BatchMigrateResourcesResponse');
        const batchMigrateResourcesMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.BatchMigrateResourcesOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.MigrationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.migrationServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.MigrationService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1beta1
                    .MigrationService, this._opts, this._providedCustomServicePath);
     ...
     * @example <caption>include:samples/generated/v1beta1/migration_service.batch_migrate_resources.js</caption>
     * region_tag:aiplatform_v1beta1_generated_MigrationService_BatchMigrateResources_async
     */
     ...
     *       of
     *       {@link protos.google.cloud.aiplatform.v1beta1.MigratableResource|MigratableResource}:
     ...
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.aiplatform.v1beta1.MigratableResource|MigratableResource} on 'data' event.
     ...
     *   {@link protos.google.cloud.aiplatform.v1beta1.MigratableResource|MigratableResource}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta1/migration_service.search_migratable_resources.js</caption>
     * region_tag:aiplatform_v1beta1_generated_MigrationService_SearchMigratableResources_async
     */
