 ...
 * @memberof v1
 */
export declare class MigrationServiceClient {
    private _terminated;
    private _opts;
     ...
     */
    batchMigrateResources(request?: protos.google.cloud.aiplatform.v1.IBatchMigrateResourcesRequest, options?: CallOptions): Promise<[
    ...
    batchMigrateResources(request: protos.google.cloud.aiplatform.v1.IBatchMigrateResourcesRequest, options: CallOptions, callback: Callback<LROperation<protos.google.cloud.aiplatform.v1.IBatchMigrateResourcesResponse, protos.google.cloud.aiplatform.v1.IBatchMigrateResourcesOperationMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    batchMigrateResources(request: protos.google.cloud.aiplatform.v1.IBatchMigrateResourcesRequest, callback: Callback<LROperation<protos.google.cloud.aiplatform.v1.IBatchMigrateResourcesResponse, protos.google.cloud.aiplatform.v1.IBatchMigrateResourcesOperationMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * region_tag:aiplatform_v1_generated_MigrationService_BatchMigrateResources_async
     */
    checkBatchMigrateResourcesProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.BatchMigrateResourcesResponse, protos.google.cloud.aiplatform.v1.BatchMigrateResourcesOperationMetadata>>;
    /**
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is Array of {@link protos.google.cloud.aiplatform.v1.MigratableResource|MigratableResource}.
     ...
     *   for more details and examples.
     */
    searchMigratableResources(request?: protos.google.cloud.aiplatform.v1.ISearchMigratableResourcesRequest, options?: CallOptions): Promise<[
     ...
     *   for more details and examples.
     */
    searchMigratableResourcesStream(request?: protos.google.cloud.aiplatform.v1.ISearchMigratableResourcesRequest, options?: CallOptions): Transform;
    /**
     ...
     */
    searchMigratableResourcesAsync(request?: protos.google.cloud.aiplatform.v1.ISearchMigratableResourcesRequest, options?: CallOptions): AsyncIterable<protos.google.cloud.aiplatform.v1.IMigratableResource>;
    /**
