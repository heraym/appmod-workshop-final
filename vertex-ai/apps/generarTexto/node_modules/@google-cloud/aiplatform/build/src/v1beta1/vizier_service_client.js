...
class VizierServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const suggestTrialsResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.SuggestTrialsResponse');
        const suggestTrialsMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.SuggestTrialsMetadata');
        const checkTrialEarlyStoppingStateResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CheckTrialEarlyStoppingStateResponse');
        const checkTrialEarlyStoppingStateMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CheckTrialEarlyStoppingStateMetatdata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.VizierService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.vizierServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.VizierService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1beta1.VizierService, this._opts, this._providedCustomServicePath);
