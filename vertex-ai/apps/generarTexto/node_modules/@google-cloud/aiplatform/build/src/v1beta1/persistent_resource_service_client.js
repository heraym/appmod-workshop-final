 ...
 * `src/v1beta1/persistent_resource_service_client_config.json`.
...
class PersistentResourceServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createPersistentResourceResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.PersistentResource');
        const createPersistentResourceMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CreatePersistentResourceOperationMetadata');
        const deletePersistentResourceResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deletePersistentResourceMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const updatePersistentResourceResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.PersistentResource');
        const updatePersistentResourceMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdatePersistentResourceOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.PersistentResourceService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.persistentResourceServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.PersistentResourceService')
