 ...
 * `src/v1beta1/feature_registry_service_client_config.json`.
...
class FeatureRegistryServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createFeatureGroupResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.FeatureGroup');
        const createFeatureGroupMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CreateFeatureGroupOperationMetadata');
        const updateFeatureGroupResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.FeatureGroup');
        const updateFeatureGroupMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdateFeatureGroupOperationMetadata');
        const deleteFeatureGroupResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteFeatureGroupMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const createFeatureResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.Feature');
        const createFeatureMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CreateFeatureOperationMetadata');
        const updateFeatureResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.Feature');
        const updateFeatureMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdateFeatureOperationMetadata');
        const deleteFeatureResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteFeatureMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.FeatureRegistryService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.featureRegistryServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.FeatureRegistryService')
